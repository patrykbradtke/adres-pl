...
children.push(table(
  ...
  [
    ...
    ['Uwierzytelnianie klientów API', 'Częściowo', 'Prace rozpoczęte 9.08.2026 na osobnej gałęzi: model danych, format klucza i pomiar kosztu. Serwis nadal nie weryfikuje tożsamości — patrz 5.5'],
...
children.push(table(
  ...
  [
    ['Serwis nie uwierzytelnia klientów', 'Serwis nie weryfikuje tożsamości klienta, więc nie da się rozdzielić limitów ani rozliczeń per klient. Do czasu naprawy nie powinien opuszczać sieci wewnętrznej. Możliwość obejścia limitowania zamknięto 8.08.2026. Prace nad docelowym rozwiązaniem trwają od 9.08.2026 — fundament gotowy, obsługa żądania jeszcze nietknięta — patrz 5.5', '9–11 dni, z czego ok. 3 wykonane'],
